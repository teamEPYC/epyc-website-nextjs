    ...
    <>
      <LegalPage title="Terms and Conditions">
        ...
        <p>
          ...
          continue to use EPYC if you do not agree to take all of the terms and conditions stated on
          this page.
        </p>
        <p>
          The following terminology applies to these Terms and Conditions, Privacy Statement and
          Disclaimer Notice and all Agreements: &ldquo;Client&rdquo;, &ldquo;You&rdquo;, and
          &ldquo;Your&rdquo; refer to you, the person logged on to this website and compliant with
          the Company&apos;s terms and conditions. &ldquo;The Company&rdquo;,
          &ldquo;Ourselves&rdquo;, &ldquo;We&rdquo;, &ldquo;Our&rdquo;, and &ldquo;Us&rdquo; refer
          to our Company. &ldquo;Party&rdquo;, &ldquo;Parties&rdquo;, or &ldquo;Us&rdquo; refers to
          both the Client and ourselves. All terms refer to the offer, acceptance and consideration
          of payment necessary to undertake the process of our assistance to the Client most
          appropriately for the express purpose of meeting the Client&apos;s needs in respect of the
          provision of the Company&apos;s stated services following and subject to, prevailing law
        ...
        <p>You must not:</p>
        <ul>
          <li>Republish material from EPYC</li>
          <li>Sell, rent or sub-license material from EPYC</li>
          <li>Reproduce, duplicate or copy material from EPYC</li>
          <li>Redistribute content from EPYC</li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>
            The Comments do not contain defamatory, libellous, offensive, indecent or otherwise
        ...
        <ul>
          ...
          <li>
            System-wide Accredited Businesses except soliciting non-profit organisations, charity
            shopping malls, and charity fundraising groups, which may not hyperlink to our Web site.
          </li>
        </ul>
        <p>
          These organisations may link to our home page, to publications or other Website
        ...
        <p>
          These organisations may link to our home page so long as the link (a) is not in any way
        ...
        <p>
          ...
          pages that alter the visual presentation or appearance of our Website.
        </p>

        <h4>Content Liability</h4>
        <p>
          We shall not be held responsible for any content on your Website. You agree to protect and
          defend us against all claims that are rising on your Website. No link(s) should appear on
          any Website that may be interpreted as libellous, obscene or criminal or which infringes,
        ...
        <p>
          ...
          Website. You approve to remove all links to our Website upon request immediately. We also
        ...
        <p>
          If you find any link on our Website offensive for any reason, you are free to contact and
          inform us anytime. We will consider requests to remove links, but we are not obligated to
        ...
        <p>
          ...
          or that the material is kept up to date.
        </p>
